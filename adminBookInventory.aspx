         ...
         <div class="col-md-5">
            <div class="card">
               ...
               <div class="card-body"> 
                  ...
                  <div class="row center">
                     <div class="col">
                           <img id="imgview" width="100" src="bookInventory/books.jpg" runat="server"/>           
                     </div>
                  </div>
                  <div class="row">
                     <div class="col">
                  ...
                  <div class="row">
                     <div class="col">
                        <asp:FileUpload class="form-control bs-tooltip-bottom" ID="FileUpload1" runat="server" onchange="readURL(this);" />
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-md-5">
                        ...
                        <div class="form-group">
                           <div class="input-group">
                              <asp:TextBox CssClass="form-control" ID="TextBox1" runat="server" placeholder="Book ID"></asp:TextBox>
                               <asp:LinkButton  class="form-control btn btn-primary" ID="LinkButton4" runat="server" OnClick="LinkButton4_Click" Width="29px"><i class="fas fa-check-circle"></i></asp:LinkButton>
                           </div>
                        </div>
                     </div>
                     <div class="col-md-7">
                     ...
                     <div class="col-md-4">
                        ...
                        <div class="form-group">
                           <asp:DropDownList class="form-control" ID="DropDownList1" runat="server">
                              ...
                              <asp:ListItem Text="Azerbaijani" Value="Azerbaijani" />
                              <asp:ListItem Text="Japan" Value="Japanse" />
                     ...
                     <div class="col-md-4">
                        ...
                        <div class="form-group">
                           <asp:ListBox CssClass="form-control" ID="ListBox1" runat="server" SelectionMode="Multiple" Rows="5">
                              ...
                              <asp:ListItem Text="Comedy" Value="Comic Book" />
                                       ...
                                       <div class="container-fluid">
                                           <div class="row">
                                               <div class="col-lg-9">
                                                   ...
                                                   <div class="row">
                                                       <div class="col-12">
                                                           Author-<asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Size="Small" Text='<%# Eval("author_name") %>'></asp:Label>
                                                           Language-<asp:Label ID="Label4" runat="server" Font-Bold="True" Font-Size="Small" Text='<%# Eval("language") %>'></asp:Label>
                                                       </div>
                                                   </div>

                                                    <div class="row">
                                                       <div class="col-12">
                                                           Genre-<asp:Label ID="Label14" runat="server" Font-Bold="True" Font-Size="Small" Text='<%# Eval("genre") %>'></asp:Label>
                                                       </div>
                                                   </div>

                                                   <div class="row">
                                                       <div class="col-12">
                                                           Publisher-<asp:Label ID="Label5" runat="server" Font-Bold="True" Font-Size="Small" Text='<%# Eval("publisher_name") %>'></asp:Label>
                                                           Publish Date-<asp:Label ID="Label6" runat="server" Font-Bold="True" Font-Size="Small" Text='<%# Eval("publish_date") %>'></asp:Label>
                                                   ...
                                                   <div class="row">
                                                       <div class="col-12">
                                                           ...
                                                           Cost-<asp:Label ID="Label9" runat="server" Font-Bold="True" Font-Size="Small" Text='<%# Eval("book_cost") %>'></asp:Label>
                                                   ...
                                                   <div class="row">
                                                       <div class="col-12">
                                                           Description-<asp:Label ID="Label12" runat="server" Font-Bold="True" Font-Size="Small" Text='<%# Eval("book_description") %>'></asp:Label>
                                                       </div>
                                                   </div>
